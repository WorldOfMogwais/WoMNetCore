...
namespace WoMSadGui.Consoles
{
    internal class CustomAdventureStats : MogwaiConsole
    {
        ...
        private Console _backgroundConsole;
        ...
        public CustomAdventureStats(Mogwai mogwai, int width, int height) : base("Adventure Extension", "This is a temp. summary expect more here", width, height)
        {
            ...
            // Load the logo
            var imageStream = TitleContainer.OpenStream("victory.png");
            ...
            //_consoleImage.ViewPort = new Rectangle(0,0, _consoleImage.Width, height);
            //_consoleImage.Resize(width, height, false);
            ...
            //_scrollingConsole.MainConsole.Children.Add(_statsConsole);
        ...
        public void Update()
        {
            ...
            _statsConsole.Fill(DefaultForeground, new Color(20,20,20,100), null);
            ...
            switch (_mogwai.Adventure.AdventureState)
            {
                ...
                case AdventureState.Completed:
                    ...
                    _statsConsole.Print(1, 2, $"You killed {Coloring.DoDmg(_mogwai.Adventure.MonstersList.Count(p => p.IsDead))} monsters and explored");
                    _statsConsole.Print(1, 3, $"this dungeon, no monster was able to take it up with your power!");
        ...
        {
            _rewardConsole.Fill(DefaultForeground, new Color(100,0,200,200), null);
            ...
            _rewardConsole.Print(12, 2, $"{_mogwai.Adventure.Map.GetExplorationState():0.0%}".PadLeft(6), Color.LimeGreen);
