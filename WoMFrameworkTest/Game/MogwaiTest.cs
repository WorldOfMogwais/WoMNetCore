namespace WoMFramework.Game.Model.Tests
{
    public class MogwaiTest
    {
        ...
        //    Assert.Equal(18, stringArray.Length);
        //    Assert.Equal("163d", stringArray[0]);
        //    Assert.Equal("2e38", stringArray[1]);
        //    Assert.Equal("3c77", stringArray[2]);
        //    Assert.Equal("7652", stringArray[3]);
        //    Assert.Equal("32be", stringArray[4]);

        //    Assert.Equal("cf", stringArray[17]);
        //}
    }
}